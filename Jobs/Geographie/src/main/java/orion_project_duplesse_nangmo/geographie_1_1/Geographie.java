...
package orion_project_duplesse_nangmo.geographie_1_1;
...
/**
 * Job: Geographie Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Geographie implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Geographie";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Geographie.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:TTZcNG2kyTvLz/hGX7A8AC2ffkbi7xHVuFu/5GEeSvwZP8TmkbdiWB8=");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ORION_PROJECT_DUPLESSE_NANGMO_Geographie = new byte[0];
    static byte[] commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie.length) {
				if(length < 1024 && commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie.length == 0) {
   					commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie = new byte[1024];
				} else {
   					commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie, 0, length);
			strReturn = new String(commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie, 0, length);
			strReturn = new String(commonByteArray_ORION_PROJECT_DUPLESSE_NANGMO_Geographie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ORION_PROJECT_DUPLESSE_NANGMO_Geographie) {
 ...
 */
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SwSC4NVzfLlmKW9briTdBtzb7ep/0m1jWebd+vQ47ozZSB4czk2TxboSNxWEb1w=");
 ...
 */
    ...
    public static void main(String[] args){
        final Geographie GeographieClass = new Geographie();

        int exitCode = GeographieClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Geographie.class.getClassLoader().getResourceAsStream("orion_project_duplesse_nangmo/geographie_1_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Geographie.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Geographie");
        }
...
/************************************************************************************************
 *     283090 characters generated by Talend Open Studio for Data Integration 
 *     on the 13 février 2025 à 06:01:05 WAT
 ************************************************************************************************/